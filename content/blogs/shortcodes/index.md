...
```md
{{</* button href="https://blowfish.page/docs/getting-started/" */>}}
Get started
{{</* /button */>}}
```
...
Icons can also be used in partials by calling the [icon partial](https://blowfish.page/docs/partials/#icon).
